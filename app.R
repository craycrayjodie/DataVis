  ...
  navbarPage(
    ...
    tabPanel("Map",
             div(class = "outer",
                ...
                #Note that for the Firefox browser the selected state "March" is not applied when the page loads (which it should) on the "Maps" default page. This only occurs after I publish to shinyapps. 
                #The app works fine locally (in all Browsers - IE, Chrome and Firefrox) with the data loaded for March displaying in the app when the app loads.
